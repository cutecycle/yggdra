...
#[cfg(test)]
mod tests {
    use yggdra::tools::{Tool, ToolRegistry, RipgrepTool, CommitTool, EditfileTool, PythonTool};
    use std::fs;
    ...
    fn test_editfile_blocks_path_traversal() {
        ...
        assert!(tool.validate_input("../../sensitive/file.txt").is_err());
        ...
        assert!(tool.validate_input("./directory/file.txt").is_ok());
    }
